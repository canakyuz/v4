...
export const BentoGridItem = ({ props, className }: BentoGridItemProps) => {
  ...
  return (
    <Link href={linkHref}>
      <div className={cn(
        "row-span-1 rounded-xl group/bento hover:shadow-xl transition duration-200 shadow-input dark:shadow-none p-4 border-card bg-card border-2 justify-between flex flex-col space-y-4 animate-in font-body",
        className
      )}>
        <Image
